...
<?php
	if($this->params->get('show_image') && !empty($this->element->file_path)){
		...
		if(is_file($this->image->getPath($this->element->file_path,false))){
?>
...
<?php
		...
		} elseif(!$this->params->get('category_has_subcategories', 0)) {
			echo '<div class="hk-well hika_no_products"><i class="far fa-circle-xmark"></i> ' . JText::_('HIKASHOP_NO_PRODUCTS') . '</div>';
		}
	}
