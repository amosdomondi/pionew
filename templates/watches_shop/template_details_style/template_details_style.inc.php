...
body {
	...
	font-size: <?= $this->params->get('body_font_size')?>px;
...
*:focus {
	outline-color:<?= $this->params->get('focus_color')?>;
	outline-style:<?= $this->params->get('focus_style')?>;
	outline-width:<?= $this->params->get('focus_width')?>px;
	outline-offset:<?= $this->params->get('focus_offset')?>px;
}
...
<?php 
	...
	$section_font_size = $section_class . '_font_size';
	$section_font_size_links = $section_class . '_font_size_links';
...
?>
       ...
       .<?= "$section_class"; ?>{
		...
		<?php if ($this->params->get($expand_section_font)==1): ?>
			...
			font-size: <?= $this->params->get($section_font_size)?>px;
		...
		<?php if ($this->params->get($expand_section_font)==1): ?>
			...
			font-size: <?= $this->params->get($section_font_size_links)?>px;
			}
