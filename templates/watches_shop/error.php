...
<center>
    ...
    <?php
     ...
     if( JFactory::getConfig()->get('error_reporting') === "default" 
      || JFactory::getConfig()->get('error_reporting') === "none" 
    ...
    print_r("<br /> Line: ". $this->error->getLine()); 
      if (version_compare(JVERSION, "4.0.0-alpha10", "lt")) {
        ...
        echo "<br />";    
        echo "<br />  Database log: ";     
        print_r( $db->stderr(true) );    
      } else {
        echo "<br /><pre>  Trace: "; 
          print_r(JLayoutHelper::render('joomla.error.backtrace', 
              array('backtrace' => $this->error->getTrace())));
        echo "</pre>";
      }    
    echo "<br />";  
