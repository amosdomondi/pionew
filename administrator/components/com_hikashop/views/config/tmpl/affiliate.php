...
<?php } ?>
	...
	<tr>
		<td class="hk_tbl_key"<?php echo $this->docTip('affiliation_category_restriction');?>><?php echo JText::_('AFFILIATION_CATEGORY_RESTRICTION'); ?></td>
		<td><?php
			$categories = null;
			$dbCategories = $this->config->get('affiliation_category_restriction', '');
			if(!empty($dbCategories))
				$categories = explode(',', $dbCategories);
			echo $this->nameboxType->display(
				'config[affiliation_category_restriction]',
				$categories,
