...
<table class="hk_config_table table" style="width:100%">
	...
	<tr id="method_button_mode_tr">
		<td class="hk_tbl_key"<?php echo $this->docTip('method_button_mode');?>><?php echo JText::_('METHOD_BUTTON_MODE'); ?></td>
		<td><?php
			$values = array(
				JHTML::_('select.option', 'default', JText::_('HIKA_DEFAULT')),
				JHTML::_('select.option', 'button', JText::_('FACEBOOK_DISPLAY_STYLE_BUTTON'))
			);
			echo JHTML::_('hikaselect.radiolist',  $values, 'config[method_button_mode]', 'class="custom-select"', 'value', 'text', $this->config->get('method_button_mode', 'default'));
		?></td>
	</tr>
