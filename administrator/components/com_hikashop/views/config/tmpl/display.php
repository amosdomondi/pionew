...
?>
	...
	<tr>
		<td class="hk_tbl_key"<?php echo $this->docTip('form_select_class');?>><?php echo JText::_('HIKA_FORM_SELECT_CLASS'); ?></td>
		<td>
			<input type="text" class="large" placeholder="form-select" name="config[form_select_class]" value="<?php echo $this->escape($this->config->get('form_select_class', '')); ?>"/>
		</td>
	</tr>
	<tr>
		<td class="hk_tbl_key"<?php echo $this->docTip('form_control_class');?>><?php echo JText::_('HIKA_FORM_CONTROL_CLASS'); ?></td>
		<td>
			<input type="text" class="large" placeholder="form-control" name="config[form_control_class]" value="<?php echo $this->escape($this->config->get('form_control_class', '')); ?>"/>
		</td>
	</tr>
	<tr>
		<td class="hk_tbl_key"<?php echo $this->docTip('group_class');?>><?php echo JText::_('HIKA_GROUP_CLASS'); ?></td>
		<td>
			<input type="text" class="large" placeholder="input-group" name="config[group_class]" value="<?php echo $this->escape($this->config->get('group_class', '')); ?>"/>
		</td>
	</tr>
...
?>
	...
	<tr>
		<td class="hk_tbl_key"<?php echo $this->docTip('display_bundled_products');?>><?php echo JText::_('DISPLAY_BUNDLED_PRODUCTS_ON_PRODUCT_PAGE');?></td>
		<td><?php echo JHTML::_('hikaselect.booleanlist', 'config[display_bundled_products]', '', @$this->config->get('display_bundled_products',0)); ?></td>
	</tr>	
	<tr>
