...
function changeRegistrationButtonType(init){
	...
	var method_button_mode_tr = window.document.getElementById('method_button_mode_tr');
	...
	if(display==true){
		...
		method_button_mode_tr.style.display = 'none';
	}else{
		...
		method_button_mode_tr.style.display = 'table-row';
	}
	if(!init){
