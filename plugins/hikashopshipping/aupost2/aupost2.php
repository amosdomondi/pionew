...
class plgHikashopshippingAupost2 extends hikashopShippingPlugin {
	...
	var $pluginConfig = array(
		...
		'services' => array('SHIPPING_SERVICES', 'checkbox',array(
			...
			'AUS_PARCEL_REGULAR_SATCHEL_EXTRA_SMALL' => 'Parcel Post Extra Small Satchel',
			'AUS_PARCEL_REGULAR_SATCHEL_250G' => 'Parcel Post Extra Small (250g) Satchel',
			'AUS_PARCEL_REGULAR_SATCHEL_500G' => 'Parcel Post Small (500g) Satchel',
			'AUS_PARCEL_REGULAR_SATCHEL_3KG' => 'Parcel Post Medium (3Kg) Satchel',
			'AUS_PARCEL_REGULAR_SATCHEL_5KG' => 'Parcel Post Large (5Kg) Satchel',
			'AUS_PARCEL_REGULAR_PACKAGE_EXTRA_SMALL' => 'Parcel Post Extra Small Package',
			'AUS_PARCEL_EXPRESS' => 'Express Post (your own packaging)',
			'AUS_PARCEL_EXPRESS_SATCHEL_EXTRA_SMALL' => 'Express Post Extra Small Satchel',
			'AUS_PARCEL_EXPRESS_SATCHEL_250G' => 'Express Post Extra Small (250g) Satchel',
			'AUS_PARCEL_EXPRESS_SATCHEL_500G' => 'Express Post Small (500g) Satchel',
			...
			'AUS_PARCEL_EXPRESS_PACKAGE_EXTRA_SMALL' => 'Express Post Extra Small Package',
	...
	var $shipping_types = array(
		...
		'AUS_PARCEL_EXPRESS_SATCHEL_EXTRA_SMALL' => 18,
		'AUS_PARCEL_EXPRESS_PACKAGE_EXTRA_SMALL' => 19,
		'AUS_PARCEL_EXPRESS_SATCHEL_250G' => 20,
		'AUS_PARCEL_REGULAR_SATCHEL_EXTRA_SMALL' => 21,
		'AUS_PARCEL_REGULAR_PACKAGE_EXTRA_SMALL' => 22,
		'AUS_PARCEL_REGULAR_SATCHEL_250G' => 23,
		);
	...
	var $local_shipping_types = array(
		'AUS_PARCEL_REGULAR',
		'AUS_PARCEL_REGULAR_SATCHEL_EXTRA_SMALL',
		'AUS_PARCEL_REGULAR_SATCHEL_250G',
		'AUS_PARCEL_REGULAR_SATCHEL_500G',
		'AUS_PARCEL_REGULAR_SATCHEL_3KG',
		'AUS_PARCEL_REGULAR_SATCHEL_5KG',
		'AUS_PARCEL_REGULAR_PACKAGE_EXTRA_SMALL',
		'AUS_PARCEL_EXPRESS',
		'AUS_PARCEL_EXPRESS_SATCHEL_EXTRA_SMALL',
		'AUS_PARCEL_EXPRESS_SATCHEL_250G',
		'AUS_PARCEL_EXPRESS_SATCHEL_500G',
		'AUS_PARCEL_EXPRESS_SATCHEL_3KG',
		'AUS_PARCEL_EXPRESS_SATCHEL_5KG',
		'AUS_PARCEL_EXPRESS_PACKAGE_EXTRA_SMALL',
	);
	...
	function addRate(&$rates,$parcel,&$rate,$currency, $nb_package, &$messages) {
		...
		if(isset($serviceTypesJSON->services->service) && !empty($serviceTypesJSON->services->service)) {
			...
			if(count($rates) < 1) {
				hikashop_writeToLog($available_service);
				$messages['aupostv2_error_message'] = 'No shipping methods found. Other services are available but not selected in the Australia Post shipping method';
			}
		} else {
